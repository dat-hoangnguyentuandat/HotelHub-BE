...
SELECT 'Gói Tuần Trăng Mật', 'Gói ưu đãi', 1500000, 'gói',
       ...
       'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800', 'ACTIVE', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM additional_services WHERE name = 'Gói Tuần Trăng Mật');
UPDATE additional_services SET image_url = 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800' WHERE name = 'Gói Tuần Trăng Mật';
...
SELECT 'Gói Chào Mừng VIP', 'Gói ưu đãi', 600000, 'gói',
       ...
       'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=800', 'ACTIVE', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM additional_services WHERE name = 'Gói Chào Mừng VIP');
UPDATE additional_services SET image_url = 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=800' WHERE name = 'Gói Chào Mừng VIP';
